...
public class AdaptadorTienda extends RecyclerView.Adapter<AdaptadorTienda.ProductosViewHolder> implements View.OnClickListener {

    private ArrayList<Tiendaszona> tiendaszonas;
    private Context context;
    private View.OnClickListener listener;

    public AdaptadorTienda(Context context, ArrayList<Tiendaszona> tiendaszonas) {
        this.context = context;
        this.tiendaszonas = tiendaszonas;
    }
//----------Adaptador

    @Override
    public ProductosViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardenda, parent, false);
    ...
    public void onBindViewHolder(ProductosViewHolder holder, int position) {
       // holder.txtDescripcion.setText(android_versions.get(position).getAndroid_version_name());
        holder.txtZona.setText(tiendaszonas.get(position).getZona());
